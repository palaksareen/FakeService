 ...
 * 
 */
@WebFault(name = "sendEmailFault", targetNamespace = "http://soa.o2.co.uk/sendmessagedata_1")
    ...
    extends Exception
{
     ...
     * @param message
     */
    public SendEmailFault(String message, SOAFaultType faultInfo) {
        super(message);
     ...
     * @param message
     */
    public SendEmailFault(String message, SOAFaultType faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
