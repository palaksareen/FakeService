 ...
 * 
 */
@WebFault(name = "sendSMSFault", targetNamespace = "http://soa.o2.co.uk/sendmessagedata_1")
    ...
    extends Exception
{
     ...
     * @param message
     */
    public SendSMSFault(String message, SOAFaultType faultInfo) {
        super(message);
     ...
     * @param message
     */
    public SendSMSFault(String message, SOAFaultType faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
